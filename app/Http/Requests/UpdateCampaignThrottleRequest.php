...
class UpdateCampaignThrottleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'error_threshold_percent' => ['required', 'integer', 'min:1', 'max:100'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'error_threshold_percent.required' => 'O limiar de falhas é obrigatório.',
            'error_threshold_percent.min' => 'O limiar de falhas deve ser de ao menos 1%.',
        ];
    }
}
