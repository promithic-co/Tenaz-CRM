...
class CreditoQualificacaoService
{
    ...
    public function qualificar(array $consulta): array
    {
        ...
        $valorMR = 0.0;
        if (! empty($consulta['MR'])) {
            $valorMR = (float) $consulta['MR'];
        } elseif (! empty($dadosBeneficio['valormr'])) {
            $valorMR = (float) $dadosBeneficio['valormr'];
        } elseif (! empty($dadosBeneficio['vlbasecalc'])) {
            $valorMR = (float) $dadosBeneficio['vlbasecalc'];
        }
