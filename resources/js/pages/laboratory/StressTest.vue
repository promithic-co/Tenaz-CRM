...
const label = ref('');
const objective = ref(
    'Testar fidelidade dos valores de crédito reportados pelo agente.',
);
                    ...
                    <div class="flex flex-col gap-3">
                        <div>
                            ...
                            <input
                                v-model="label"
                                type="text"
                                placeholder="Ex: Bateria Março 2026"
                        ...
                        <div>
                            <label
                                class="mb-1 block text-xs text-muted-foreground"
                                >Objetivo do teste</label
                            >
                            <textarea
                                v-model="objective"
                                rows="3"
                                placeholder="Testar fidelidade dos valores de crédito..."
                                class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                            ></textarea>
                        </div>
                        <div>
                            <label
                                class="mb-1 block text-xs text-muted-foreground"
                                >Dataset de CPFs (opcional)</label
                            >
                            <select
                                v-model="cpfDatasetId"
                                class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                            >
                        ...
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            ...
                            <div>
                                <label
                                    class="mb-1 block text-xs text-muted-foreground"
                                    >Rodadas por ciclo (1–15)</label
                                >
                                <input
                                    v-model.number="roundsPerCycle"
                                    type="number"
                                    min="1"
                                    max="15"
                                    class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <td class="px-4 py-2 text-muted-foreground">
                                        ...
                                        >
                                            {{
                                                r.results_summary.average_fidelity_score.toFixed(
                                                    1,
                                                )
                                            }}%
                                        </template>
