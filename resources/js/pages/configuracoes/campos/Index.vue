...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="max-w-3xl space-y-6 p-3 sm:p-4">
            <div
            ...
            >
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Informações que a sua operação precisa guardar de cada
                        lead. Aparecem no painel da conversa para a equipe
                        preencher.
                    </p>
                </div>
                <button
            ...
            >
                ...
                <div v-if="createForm.type === 'select'" class="space-y-1.5">
                ...
                <div class="flex gap-2">
                    ...
                    >
                        {{ createForm.processing ? 'Criando…' : 'Criar campo' }}
                    </button>
                    <button
                        type="button"
            ...
            >
                ...
                <p class="mx-auto mt-1 max-w-md text-sm text-muted-foreground">
                    Crie campos para o que a sua equipe sempre pergunta e hoje
                    escreve nas notas — renda, imóvel de interesse, matrícula.
                    Eles viram filtros de lista e campos do painel.
                </p>
            </div>
