...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-5 p-3 sm:p-4 lg:p-8">
            <div
                v-if="flash"
            ...
            >
                <div>
                    ...
                    <p class="text-xs text-muted-foreground">
                        Cada instância WhatsApp deve estar vinculada a um
                        agente.
                    </p>
                </div>
                <Link
            ...
            >
                ...
                >
                    ...
                    >
                            ...
                            <button
                                ...
                                :title="
                                    agent.is_active
                                        ...
                                        : 'Ativar agente'
                                "
                                class="mt-0.5 size-2 shrink-0 cursor-pointer rounded-full ring-2 ring-transparent transition-colors hover:ring-offset-1 hover:ring-offset-background"
                                :class="
                                    agent.is_active
                                        ? 'bg-emerald-500 hover:ring-emerald-500/50'
                                        : 'bg-muted-foreground/40 hover:ring-muted-foreground/30'
                                "
                            ...
                            <div class="min-w-0">
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        :class="
                                            agent.specialization.badge_classes
                                        "
                                    >
                                ...
                                <p
                                    v-if="
                                        ...
                                        agent.display_agent_name !== agent.name
                                    "
                        ...
                        <div class="flex shrink-0 items-center gap-1.5">
                            <span
                                ...
                                :class="
                                    templateBadge(agent.template_slug)!.classes
                                "
                            >
                    ...
                    <p
                        v-if="editingAgentId !== agent.id && agent.description"
                    ...
                    <div v-if="editingAgentId === agent.id" class="space-y-2">
                        <div>
                            <input
                                ...
                                type="text"
                                maxlength="100"
                                class="w-full rounded-md border border-input bg-background px-2 py-1 text-sm font-semibold text-foreground focus:ring-1 focus:ring-primary focus:outline-none"
                        ...
                        <textarea
                            ...
                            maxlength="255"
                            rows="2"
                            class="w-full resize-none rounded-md border border-input bg-background px-2 py-1 text-xs text-muted-foreground focus:ring-1 focus:ring-primary focus:outline-none"
                        ...
                        <div class="flex justify-end gap-1">
                            ...
                            <button
                                ...
                                class="rounded p-1 text-primary transition-colors hover:bg-primary/10 hover:text-primary/80 disabled:opacity-50"
                                title="Salvar"
                    ...
                    >
                        ...
                        <p class="mt-0.5 text-[10px] text-muted-foreground">
                            Conversas existentes serão mantidas. A instância
                            WhatsApp será desvinculada.
                        </p>
                        <div class="mt-2 flex gap-1.5">
                            <button
                                type="button"
                                class="rounded bg-destructive px-2 py-1 text-[10px] text-destructive-foreground transition-colors hover:bg-destructive/90"
                            ...
                            <button
                                type="button"
                                class="rounded border border-input px-2 py-1 text-[10px] transition-colors hover:bg-accent"
                        ...
                        >
                            <div class="flex min-w-0 items-center gap-1.5">
                                ...
                                <span v-if="agent.instance" class="truncate">
                                    ...
                                    <span
                                        v-if="agent.instance.phone_number"
                            ...
                            <button
                                type="button"
                                class="ml-1 shrink-0 rounded p-0.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
                    ...
                    <!-- Metrics row -->
                    <div
                        class="mt-3 mb-3 grid grid-cols-2 gap-2 sm:grid-cols-3"
                    >
                        <div
                        ...
                        >
                            <span
                                ...
                                :class="
                                    (agent.conversion_rate ?? 0) >= 10
                                        ? 'text-emerald-400'
                                        : (agent.conversion_rate ?? 0) > 0
                                          ? 'text-amber-400'
                                          : 'text-muted-foreground'
                                "
                            >
                    ...
                    <!-- Model pill -->
                    <div
                        v-if="modelLabel(agent.provider, agent.model)"
                        class="mt-2"
                    >
                        <span
                    ...
                    <div class="mt-3 flex flex-wrap gap-2">
                        <Link
                            ...
                            class="flex-1 rounded-md bg-primary px-3 py-1.5 text-center text-xs font-medium text-primary-foreground hover:bg-primary/90"
                        >
                            Config
                        </Link>
                        <Link
                            :href="`/agentes/${agent.id}/regras-operacionais`"
                            class="flex-1 rounded-md border border-input px-3 py-1.5 text-center text-xs font-medium hover:bg-accent"
                        >
                            Regras
                        </Link>
                        <Link
                        ...
                        >
                            <div class="min-w-0">
                                ...
                                <p class="text-[10px] text-muted-foreground/70">
                                    Arquivado em {{ archived.deleted_at }}
                                </p>
                            </div>
                            <button
                                type="button"
                                class="flex items-center gap-1 rounded-md border border-input px-2 py-1 text-[10px] font-medium transition-colors hover:bg-accent"
                                :disabled="archiveForm.processing"
        ...
        >
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle
                        >Alterar instância —
                        {{ selectedAgent?.name }}</DialogTitle
                    >
                </DialogHeader>

                <div v-if="selectedAgent" class="space-y-4 py-2">
                    <p class="text-xs text-muted-foreground">
                        Selecione a instância WhatsApp que será usada por este
                        agente. Novas mensagens recebidas serão roteadas
                        automaticamente.
                    </p>
                    ...
                    <div class="space-y-2">
                        ...
                        <label
                            ...
                            :class="
                                instanceForm.whatsapp_instance_id === null
                        ...
                        >
                            ...
                            >
                                <span
                                    v-if="
                                        instanceForm.whatsapp_instance_id ===
                                        null
                                    "
                                ...
                                <p class="truncate text-sm font-medium">
                                    ...
                                    <span
                                        v-if="
                                            ...
                                            instance.id
                                        "
                                        class="ml-1.5 text-[10px] font-normal text-primary"
                                        >(atual)</span
                                    >
                                </p>
                                <p
                        ...
                        <p
                            v-if="
                                optionsForAgent(selectedAgent).length === 0 &&
                                !selectedAgent.instance
                            "
                            class="py-3 text-center text-xs text-muted-foreground"
                        >
                            Nenhuma instância disponível. Crie uma em
                            <Link
                                href="/whatsapp"
                ...
                <DialogFooter class="gap-2">
                    <button
                        type="button"
                        class="rounded-md border border-input px-4 py-2 text-sm transition-colors hover:bg-accent"
                        @click="closeModal"
                    >
                        Cancelar
                    </button>
