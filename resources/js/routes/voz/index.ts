...
export const previewTts = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: previewTts.url(options),
    method: 'post',
})

previewTts.definition = {
    methods: ["post"],
    url: '/voz/preview-tts',
} satisfies RouteDefinition<["post"]>
...
previewTts.url = (options?: RouteQueryOptions) => {
    return previewTts.definition.url + queryParams(options)
}
 ...
 */
    ...
    previewTts.form = previewTtsForm
const voz = {
    index: Object.assign(index, index),
store: Object.assign(store, store),
update: Object.assign(update, update),
destroy: Object.assign(destroy, destroy),
previewTts: Object.assign(previewTts, previewTts),
}
