 ...
 */
export const throttle = (args: { campanha: number | { id: number } } | [campanha: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/campanhas/{campanha}/throttle'
 */
throttle.url = (args: { campanha: number | { id: number } } | [campanha: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { campanha: args }
    }
    ...
    return throttle.definition.url
            .replace('{campanha}', parsedArgs.campanha.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/campanhas/{campanha}/throttle'
 */
throttle.patch = (args: { campanha: number | { id: number } } | [campanha: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: throttle.url(args, options),
    method: 'patch',
})
 ...
 * @route '/campanhas/{campanha}/throttle'
 */
    const throttleForm = (args: { campanha: number | { id: number } } | [campanha: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/campanhas/{campanha}/throttle'
 */
        throttleForm.patch = (args: { campanha: number | { id: number } } | [campanha: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: throttle.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
